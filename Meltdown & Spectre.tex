...
The latter is just applicable on Intel TSX processors where transient instructions can be grouped and reversed as a whole after failing.
...
This section deals with the implementation of Meltdown\footnote{https://github.com/IAIK/meltdown/tree/master/libkdump}.
Every building block of the exploit is examined gradually.
