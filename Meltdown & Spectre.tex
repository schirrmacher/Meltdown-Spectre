...
If an instruction is executed in advance because of out-of-order execution, e.g. when a branch condition is predicted incorrectly by the branch predictor, 
...
The following chapter deals with the common traits and differences of Meltdown and Spectre based on the
 original papers ~\cite{lipp2018meltdown, kocher2018spectre}. This chapter highlights why the exploits are related
 and shows how they use different techniques to achieve 
 ...
 Meltdown and Spectre share 
 
 Meltdown allows to circumvent the process isolation of Intel processors and thereby reading memory of kernel processes. 
It evokes 
...
\subsection{Out-of-order Execution and Transient Instructions}
