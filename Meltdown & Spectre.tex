...
The following chapter deals with the common features and differences of Meltdown and Spectre based on the
 ...
 other processes. Meltdown exploits exceptions or traps raised by transient instructions whereas Spectre exploits 
 transient instructions by tricking the CPU's branch predictor. Meltdown enables an attacker to read memory of kernel and user processes
 ...
 Meltdown on the other hand is a more general approach with regard to its implementation.
 
\section{What Unites Them?}
\label{ch:intro:motivation}

This section deals with common features of Meltdown and Spectre namely out-of-order execution and transient instructions
which allow to create so called \textit{covert channels} by instrumenting the cache of a CPU.
